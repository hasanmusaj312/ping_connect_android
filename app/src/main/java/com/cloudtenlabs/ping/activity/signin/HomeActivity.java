...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailButton.setOnClickListener(view -> startActivity(new Intent(context, SignUpActivity.class)));
...
//                getUserProfile(loginResult.getAccessToken());
        ...
        facebookButton.setOnClickListener(view -> LoginManager.getInstance().logInWithReadPermissions(HomeActivity.this, Arrays.asList("public_profile", "email")));
    }
