...
public class ErrorUtils {
    ...
    private static Snackbar showSnackbar(View view, String message,
        ...
        if (clickListener != null) {
            ...
            snackbar.setActionTextColor(ContextCompat.getColor(App.getInstance(), R.color.imagepicker_colorPrimaryDark));
            TextView tv = snackbar.getView().findViewById(R.id.snackbar_text);
            tv.setTextColor(ContextCompat.getColor(App.getInstance(), R.color.colorAccent));
        }
        snackbar.show();
        return snackbar;
    }
